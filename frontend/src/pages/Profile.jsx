    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
      ...
      <div>
        ...
        <p className="text-xs sm:text-sm text-slate-500 dark:text-slate-400">
          Manage your contact credentials and default shipping details for fast prescription checkout.
        </p>
      </div>
        ...
        <div className="flex items-center gap-4 pb-6 border-b border-slate-100 dark:border-slate-800">
          ...
          <div className="space-y-1">
            ...
            <div className="flex items-center gap-2 text-xs text-slate-500 dark:text-slate-400">
              ...
              <span>•</span>
              <span className="capitalize font-semibold text-emerald-600">{user?.role} Account</span>
            </div>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="grid grid-cols-3 gap-3">
            <div>
              ...
              <input
                ...
                value={formData.city}
                onChange={handleChange}
                className="w-full px-3 py-2.5 rounded-xl bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-xs focus:outline-none focus:border-emerald-500"
              />
            </div>
            <div>
              <label className="block text-xs font-semibold text-slate-700 dark:text-slate-300 mb-1">
          ...
          <div className="pt-4 flex justify-end">
            <button
              type="submit"
              disabled={saving}
              className="px-6 py-2.5 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white text-xs sm:text-sm font-bold shadow-md shadow-emerald-600/20 transition flex items-center gap-2"
            >
